export const REALTIME_DATA_LISTS = [
    [
      ...
      // },
      {
        title: '宣发费用中猫眼数据服务收入（含税）',
        remarks: '',
        money: '',
        dataIndex: 'dataServiceIncome',
        unit: '万',
      },
      {
        title: '宣发费用中猫眼影迷会务收入（含税）',
        remarks: '',
        money: '',
        dataIndex: 'fansMeetingIncome',
        unit: '万',
      },
      {
        title: '宣发费用中其它收入',
        remarks: '',
        money: '',
        dataIndex: 'advertisingOtherIncome',
        unit: '万',
      },
    ],
    [
